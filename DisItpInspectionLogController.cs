...
namespace NavesPortalforWebWithCoreMvc.Controllers.DIS
{
    [Authorize]
    [CheckSession]
    public class DisItpInspectionLogController : Controller
    {
        ...
        public DisItpInspectionLogController(BM_NAVES_PortalContext repository, RfSystemContext systemContext, IBM_NAVES_PortalContextProcedures procedures)
        {
        ...
        public async Task<IActionResult> UrlDataSource(string SearchString, DateTime? StartDate, DateTime? EndDate, [FromBody] DataManagerRequest? dm)
        {
            try
            {
                ...
                List<PNAV_DIS_GET_INSPECTIONPMS_LOG_LISTResult> resultList = await _procedures.PNAV_DIS_GET_INSPECTIONPMS_LOG_LISTAsync(SearchString, StartDate, EndDate);
                ...
                int count = DataSource.Cast<PNAV_DIS_GET_INSPECTIONPMS_LOG_LISTResult>().Count();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<IActionResult> InspectionReportPopup()
        {
            return await Task.Run(()=> View());
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IActionResult CreateInspectionLog(Guid? WorkIdx, Guid? DsrIdx)
        {
            return View();
        }
    }
